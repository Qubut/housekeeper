...
CREATE VIEW db.daily_events ON CLUSTER test_cluster AS
SELECT 
...
ENGINE = ReplicatedSummingMergeTree('/clickhouse/tables/{shard}/db/mv_hourly_stats', '{replica}')
...
ENGINE = ReplicatedAggregatingMergeTree('/clickhouse/tables/{shard}/db/mv_user_activity', '{replica}')
